...
def doctor_dashboard(request):
    ...
    return render(request, 'blogpost/doctor_blogposts.html', context)
...
def patient_dashboard(request):
    ...
    return render(request, 'blogpost/blogpost_list.html', context)
...
def create_blogpost(request):
    ...
    return render(request, 'blogpost/blogpost_form.html', context)
...
def delete_blogpost(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('doctor-dashboard')
    context = {'post':post}
    return render(request, 'blogpost/delete_blogpost.html', context)
